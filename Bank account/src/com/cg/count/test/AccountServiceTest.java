...
import com.cg.count.service.AccounService;
import com.cg.count.service.IAccountService;
...
public class AccountServiceTest {
	 ...
	 public void testDepositForMobileNo(){
	 	Account ac=new Account();
	 	ac.setMobileNo("93456473");
	 	try{
	 		service.deposit(ac.getMobileNo(),222);
	 ...
	 public void testPrinttransactionDetails(){
	 	Account ac=new Account();
	 	ac.setMobileNo("7345443456");
	 	try{
	 		ac=service.printTransactionDetails(ac.getMobileNo());
	 		assertNotNull(ac);
	 	}catch(AccountException e){
	 		assert (e.getMessage()) != null;		
	 	}
